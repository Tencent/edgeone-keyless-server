...
- **[Openssl](https://github.com/openssl/openssl?tab=readme-ov-file#build-and-install)**, 需要相关库`openssl-static`(1:1.1.1k-12.tl3.1), `openssl-devel`(1:1.1.1k-12.tl3.1), and `zlib-devel`(1.2.11-25.tl3 ).
    ```bash
    #On Centos:
